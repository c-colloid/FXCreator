...
namespace colloid.FXCreator.VRCExpressionParametersExtention.CustomUI
{
	public class ToggleButton : Button,INotifyValueChanged<bool>
{
	...
	void SetStyle()
	{
		style.backgroundColor = value ? Color.blue + (Color.white * 0.6f) : Color.grey;
	}
